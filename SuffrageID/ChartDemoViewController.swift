...
class ChartDemoViewController: UIViewController, ChartViewDelegate {
    private var optionsTableView: UITableView? = nil
    let parties = ["Blockchain Deluxe", "Slalom Dallas", "Candena de tontos", "BlockOn", "ChainLink", "Denver Blockheads",
                   "TChainz", "The Ensurers", "New Kids on the Block", "Ring of Health", "bLockchAin", "TechnoCrypto"]
...
extension ChartDemoViewController: UITableViewDelegate, UITableViewDataSource {
